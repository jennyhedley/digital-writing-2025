...
If you are missing the Monday class, you will need to follow the instructions in the class [Twine resources](/resources-twine.md) folder. I expect that we will get as far as [changing the story stylesheet](/resources-twine.md#change-the-story-stylesheet) in class on Monday. We will continue learning Twine functionality on Monday 7th April - with a focus on background images/scaling images/adding audio - and Monday 14th when we will learn how to insert image maps into Twine before we move onto Bitsy games.
